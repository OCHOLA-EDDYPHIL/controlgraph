    ...
    if role is ServiceRole.EVIDENCE_WRITER:
        ...
        def traffic_reader_factory(
            ...
            if (
                ...
                or request.stable_revision != "controlgraph-reference-target-stable-v13"
                or request.candidate_revision != "controlgraph-reference-target-candidate-v13"
        ...
        def independent_reader_factory(
            ...
            if (
                ...
                != "controlgraph-reference-target-stable-v13"
                or request.candidate_revision
                != "controlgraph-reference-target-candidate-v13"
                or request.concurrency != 8
            ):
