    ...
    if role is ServiceRole.EVIDENCE_WRITER:
        ...
        def traffic_reader_factory(
            ...
            if (
                ...
                or request.stable_revision != "controlgraph-reference-target-stable-v7"
                or request.candidate_revision != "controlgraph-reference-target-candidate-v7"
        ...
        def independent_reader_factory(
            ...
            if (
                ...
                != "controlgraph-reference-target-stable-v7"
