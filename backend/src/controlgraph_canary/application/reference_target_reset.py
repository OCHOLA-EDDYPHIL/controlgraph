...
REFERENCE_TARGET_STABLE_REVISION: Final = f"{REFERENCE_TARGET_SERVICE}-stable-v19"
REFERENCE_TARGET_CANDIDATE_REVISION: Final = f"{REFERENCE_TARGET_SERVICE}-candidate-v19"
