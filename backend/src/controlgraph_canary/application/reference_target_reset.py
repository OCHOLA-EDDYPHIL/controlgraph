...
REFERENCE_TARGET_STABLE_REVISION: Final = f"{REFERENCE_TARGET_SERVICE}-stable-v12"
REFERENCE_TARGET_CANDIDATE_REVISION: Final = f"{REFERENCE_TARGET_SERVICE}-candidate-v12"
