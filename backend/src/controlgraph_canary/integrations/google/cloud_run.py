...
CLOUD_RUN_OPERATION_TIMEOUT_SECONDS: Final = 25.0
_CLOUD_RUN_READBACK_SETTLE_ATTEMPTS: Final = 14
_CLOUD_RUN_READBACK_SETTLE_DELAY_SECONDS: Final = 1.0
_CLOUD_RUN_READBACK_SETTLE_TIMEOUT_SECONDS: Final = 15.0
...
_PREVIOUS_REFERENCE_TARGET_STABLE_REVISION: Final = (
    "controlgraph-reference-target-stable-v20"
)
