...
@_async_test
async def test_reference_target_reset_migrates_the_exact_v18_baseline_to_v19() -> None:
    before = _service(
        100,
        0,
...
@_async_test
async def test_reference_target_reset_rejects_any_other_v18_traffic_shape(
    case: str,
) -> None:
    before = _service(
        100,
